...
const schema = [
  { type: 'text', name: 'username', id: 'user', required: true, min: 3, max: 6, label: 'Enter your username' },
  { type: 'email', name: 'email', id: 'email', required: true, min: 3, max: 32, label: 'Enter your email' },
  { type: 'password', name: 'password', id: 'password', required: true, min: 3, max: 6, label: 'Enter your password' },
  { type: 'link', name: 'link', label: 'Already have an account? Lets go login.', to: { name: 'Login' } },
